...
ax1.plot(Bands.get("kpoint_distances"),Bands.get("bands"), linewidth = 2, color="orange", label="spin up")
...
plt.tight_layout()
#plt.show()
plt.savefig("2H_beryllene_bands.pdf",dpi=600)