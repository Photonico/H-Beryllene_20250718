...
! handle for orbital magnetization and metaGGAs
  TYPE ham_handle
     ...
     COMPLEX(q)     , POINTER, CONTIGUOUS :: AVEC(:,:)  ! soft part of vector magnetization potential
     COMPLEX(q), POINTER, CONTIGUOUS :: MUTOT(:,:) ! derivative of energy density with respect to kinetic energy density
     COMPLEX(q)     , POINTER, CONTIGUOUS :: MU(:,:)    ! same as MUTOT, but on GRID instead of GRIDC
  END TYPE ham_handle
