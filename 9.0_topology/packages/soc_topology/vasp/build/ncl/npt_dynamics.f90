...
!**************************************************************************
 subroutine reader_npt(iu5,iu0,pmass, external_stress) 
   ...
   pmass = -1.0
   call process_incar(lopen, iu0, iu5, 'PMASS', pmass, ierr, writexmlincar)

! Target pressure tb: this is redundant - for this purpose we have variable PSTRESS
      external_pressure = 0.0
   call process_incar(lopen, iu0, iu5, 'EXTERNAL_PRESSURE', external_pressure, ierr, writexmlincar)

      external_stress = 0.0
   call process_incar(lopen, iu0, iu5, 'EXTERNAL_STRESS', external_stress, 6, ierr, writexmlincar)
...
!        metric_tensor_tmp = metric_tensor_new
      ...
      if ( n_newton_raphson_steps > n_newton_raphson_steps_max ) then
         ...
         CALL vtutor%error("n_newton_raphson_max exceeded A: stopping")
...
!     write(6,*) 'n_newton = ', n_newton_raphson_steps
      ...
      if ( n_newton_raphson_steps > n_newton_raphson_steps_max ) then
         ...
         CALL vtutor%error("n_newton_raphson_max exceeded B: stopping")
