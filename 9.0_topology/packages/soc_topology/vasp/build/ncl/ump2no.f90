...
!**********************************************************************
!
!> Calculates the MP2 natural orbitals using essentially
...
!****************************************************************************
!
!> Apply the denominator `(e_i+e_j-e_a-e_b)` to
...
!***********************************************************************
!> Calculate the fourier-transformed overlap integrals `<i|-G|a>`
...
!***********************************************************************
!> Initializes a process grid which is used for the
