...
!
      ...
      OFIELD_KAPPA=0
      CALL PROCESS_INCAR(LOPEN, IU0, IU5, 'OFIELD_KAPPA', OFIELD_KAPPA, IERR, WRITEXMLINCAR)

!
! wave vector where order field is applied

      OFIELD_K=0
      CALL PROCESS_INCAR(LOPEN, IU0, IU5, 'OFIELD_K', OFIELD_K, 3, IERR, WRITEXMLINCAR)

!
! Steinhardt-Nelson Q6 parameters
      OFIELD_Q6_NEAR = 0
      CALL PROCESS_INCAR(LOPEN, IU0, IU5, 'OFIELD_Q6_NEAR', OFIELD_Q6_NEAR, IERR, WRITEXMLINCAR)
      OFIELD_Q6_NEAR = OFIELD_Q6_NEAR**2

      OFIELD_Q6_FAR = 0
      CALL PROCESS_INCAR(LOPEN, IU0, IU5, 'OFIELD_Q6_FAR', OFIELD_Q6_FAR, IERR, WRITEXMLINCAR)
...
! soll value for order parameter
      ...
      CALL PROCESS_INCAR(LOPEN, IU0, IU5, 'OFIELD_A', OFIELD_A, IERR, WRITEXMLINCAR)
      Q_COUNTER=0
      Q_ACCUMULATED=0
      Q2_ACCUMULATED=0
...
!*********************************************************************
    ...
    SUBROUTINE PAIR_CORRECTION(NIONS, NTYP, NI_TYP, &
         A,BNORM,XC,FORCES,ENERGY,IU0,IU5,IU6)
...
!
      IF ( STATUS == 0 ) THEN 
         CALL PROCESS_INCAR(.TRUE., IU0, IU5, 'PAIRPOT', TMP, NDIM, IERR, WRITEXMLINCAR, FOUNDNUMBER=N)
