...
!
!> Performs electronic minimization using the LHF method
!
!**********************************************************************
...
SUBROUTINE ELMIN_LHF( &
  ...
  USE fock
  USE tau_mu
  USE tutor, ONLY: vtutor, isAlert, ENCUTGW_LHF
...
! same mixing for up and down channel
  ...
  IF (ENCUTGW>0) THEN
      CALL vtutor%write(isAlert, ENCUTGW_LHF)
  ENDIF
!=======================================================================
!
...
!  broyden mixing ... :
              ...
              CALL BRMIX(KINEDEN,GRIDB,GRIDC,IO,MIX,XC,B_TO_C, &
                   ...
                   DE2H,RMST,RMSC,RMSP,WEIGHT,.FALSE.,IERRBR)
              MIX%LRESET=.FALSE.
           ELSE
