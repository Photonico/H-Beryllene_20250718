...
!*******************************************************************
!
!> Returns .TRUE. if model GW is selected
!
!*******************************************************************
...
!*******************************************************************
!
!> Calculates the dynamical contribution
!
!*******************************************************************
...
!*******************************************************************
!
!> Gets the extremely oversimplified COH potential on the real space
...
!*******************************************************************
  ...
  SUBROUTINE COHSM1_RGRID(XC,ISPIN,CHDENR,SIGMA,DENCOR,GRID,OMEGA,LAECORE)
...
! local
    ...
    IF (.NOT.((XC%NXC==1).AND.(XC%ID(1)==ID_XC_COHSM))) RETURN
...
!*******************************************************************
!
!> Calculates the extremely oversimplified COH potential from the
!> supplied charge density.
!>
!> Written by gK (essentially a copy of #COHSM1_RGRID).
...
!*******************************************************************
!
!> Calculates the state dependent diagonal screened Coulomb operator
!
!*******************************************************************
