...
!>   Lebedev grids [1-6] for integration on a sphere.
!>
!>   The original C-code [1] was kindly provided by Dr. Dmitri N. Laikov and
...
!>
       ...
       CALL vtutor%error("Gen_Oh: Invalid Code")
    1  continue
       a=1.0d0
       x(1) =  a
       y(1) =  0.0d0
...
!>   Lebedev grids [1-6] for integration on a sphere.
!>
!>   The original was kindly provided by Dr. Dmitri N. Laikov and
!>   translated into fortran by Dr. Christoph van Wuellen.
!>   This subroutine was translated using a C to fortran77 conversion
!>   tool written by Dr. Christoph van Wuellen.
!>
