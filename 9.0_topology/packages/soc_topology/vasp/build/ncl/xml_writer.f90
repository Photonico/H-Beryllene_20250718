...
!=======================================================================
     ...
     &          LNONCOLLINEAR,LSORBIT,LPLANE_WISE,LASPH,LORBITALREAL
      LOGICAL   LDOWNSAMPLE
      INTEGER   IGGA2
     ...
     &          ROPT(NTYPD),DARWIN_V(NTYPD),DARWIN_R(NTYPD)
      ...
      CALL XML_INCAR('NBANDSLOW','I',NBANDSLOW,RDUM,CDUM,LDUM,CHARAC,1)
      CALL XML_INCAR('NBANDSHIGH','I',NBANDSHIGH,RDUM,CDUM,LDUM,CHARAC,1)
      ...
      CALL XML_INCAR('KBLOWUP','L',IDUM,RDUM,CDUM,LKBLOWUP,CHARAC,1)
      CALL XML_CLOSE_TAG
      ...
      CALL XML_INCAR('LORBIT','I',LORBIT,RDUM,CDUM,LDUM,CHARAC,1)
      ...
      IF (EFERMI == HUGE(1._q)) THEN
! The Efermi tag is not set and hence written out as (0._q,0._q)
          CALL XML_INCAR('EFERMI','F',IDUM,0._q,CDUM,LDUM,CHARAC,1)
      ELSE
      ...
      CALL XML_INCAR('LDOWNSAMPLE','L',IDUM,RDUM,CDUM,LDOWNSAMPLE,CHARAC,1)
      ...
      CALL XML_INCAR('PHON_NSTRUCT','I',PHON_NSTRUCT,RDUM,CDUM,LDUM,CHARAC,1)
