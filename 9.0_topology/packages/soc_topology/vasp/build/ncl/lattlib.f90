...
!>
!> \param[in]
!>      TAU contains the atomic positions (for (1._q,0._q) species) to be ordered.
!> \param[in]
!>      NA contains the number of atomic positions
!> \param[in]
...
!>
!> \param[in]
!>    TAU1 contains the atomic positions (for (1._q,0._q) species) in cell 1
...
! Only if all DIFVs are (0._q,0._q) TNTRAN (starting with the value TRUE) will
