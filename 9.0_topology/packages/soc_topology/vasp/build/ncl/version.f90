...
module version
   ...
   integer, parameter :: minor = 5  !< Minor version number of VASP
   integer, parameter :: patch = 0  !< Patch version number of VASP
   character(len=*), parameter :: date = '16Dec24'  !< When this version of VASP was released
...
# 24
      ...
      build = '(build ' // "Sep 22 2026" // ' ' // "16:26:42" // ')'
# 30
