...
!>
!>- INIPRE
!>        - 0 standard operation (performe extrapolation)
...
!>- @paramIPRE    prediction of wavefunctions and eigenvalues performed
!>          -     0  nothing 1._q
...
!$ACC UPDATE SELF(W%CPTWFP,W%CPROJ,CSTRF) IF_PRESENT IF(OFFLOAD_ON) WAIT
!! 
...
!! 
!$ACC UPDATE DEVICE(W%CPTWFP,W%CPROJ,CSTRF) IF_PRESENT 
